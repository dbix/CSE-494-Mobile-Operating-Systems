 ...
 */
public class OldestGraphView extends View {
	...
	public OldestGraphView(Context context) {
		super(context);
		init(null, 0);
	...
	public OldestGraphView(Context context, float[] values, String title,
	...
	public OldestGraphView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}
	...
	public void setData(float[] data) {
		this.values = data;
		int incVert = (int) Math.ceil((this.getMax() - this.getMin()) / data.length);
		for (int i = 0; i <= this.getMax()+1; i = i + incVert) {
			this.verlabels[i] = "" + i;
		}
		for (int i = 0; i <= 20; i++) {
			horlabels[i] = "" + i;
